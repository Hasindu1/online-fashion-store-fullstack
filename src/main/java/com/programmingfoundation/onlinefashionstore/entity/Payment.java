...
public class Payment {
    ...
    public Payment(String id, String user_id, double total, String paymentType, String address, String date, List<UserProductDTO> order) {
        this.id = id;
...
//    public Payment(String id, String user_id, double total, String paymentType, String address, String date) {
//        this.id = id;
//        this.user_id = user_id;
//        this.total = total;
//        this.paymentType = paymentType;
